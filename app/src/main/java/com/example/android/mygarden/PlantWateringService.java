...
public class PlantWateringService extends IntentService {
    ...
    public PlantWateringService(){super("com.example.android.mygarden.PlantWateringService");}

    /**
     * Starts this service to perform WaterPlants action with the given parameters. If the service
     * is already performing a task this task will be queued.
     * @see IntentService
     */
