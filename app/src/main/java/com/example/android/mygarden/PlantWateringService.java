...
public class PlantWateringService extends IntentService {
    ...
    // TODO (1): Change ACTION_WATER_PLANT to ACTION_WATER_PLANT
    ...
    public static void startActionWaterPlants(Context context, long plantId) {
        ...
        // Todo (1a) use EXTRA_PLANT_ID to pass the plant ID to the service
    ...
    private void handleActionWaterPlants(long plantId) {
        ...
        // Update widget after watering plant
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        boolean canWater = false; // Default is to hide the water drop button
