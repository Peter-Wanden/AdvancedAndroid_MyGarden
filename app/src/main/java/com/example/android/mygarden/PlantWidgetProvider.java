...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    // TODO (2a): Modify updateAppWidget to pass the plant ID as well as a boolean to show/hide the water button
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        } else { // Set onClick to open detail activity
    ...
    // TODO (2b): Modify updatePlantWidgets to pass the plant ID as well as a boolean
