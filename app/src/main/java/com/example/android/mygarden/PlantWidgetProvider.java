...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    // TODO (2): Move the updateAppWidget loop to a new method called updatePlantWidgets and pass
    // through the image recourse. There may be multiple widgets active, so update all of them
